...
import { DeflatingERC20__factory as DeflatingERC20, ISishiswapPair__factory as ISishiswapPair } from '../typechain'
...
describe('SishiswapRouter02', () => {
  ...
  it('getAmountOut', async () => {
    ...
    await expect(router.getAmountOut(bigNumberify(0), bigNumberify(100), bigNumberify(100))).to.be.revertedWith(
      'SishiswapLibrary: INSUFFICIENT_INPUT_AMOUNT'
    )
  ...
  it('getAmountIn', async () => {
    ...
    await expect(router.getAmountIn(bigNumberify(0), bigNumberify(100), bigNumberify(100))).to.be.revertedWith(
      'SishiswapLibrary: INSUFFICIENT_OUTPUT_AMOUNT'
    )
...
describe('fee-on-transfer tokens', () => {
  ...
  beforeEach(async function () {
    ...
    pair = new Contract(pairAddress, JSON.stringify(ISishiswapPair.abi), provider).connect(wallet)
  })
