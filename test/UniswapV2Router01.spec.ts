...
import { bigNumberify, expandTo18Decimals, getApprovalDigest, mineBlock, MINIMUM_LIQUIDITY } from './shared/utilities'
...
enum RouterVersion {
  SishiswapRouter01 = 'SishiswapRouter01',
  SishiswapRouter02 = 'SishiswapRouter02'
}

describe('SishiswapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function () {
      ...
      router = {
        [RouterVersion.SishiswapRouter01]: fixture.router01,
        [RouterVersion.SishiswapRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.SishiswapRouter01]: 102365,
              [RouterVersion.SishiswapRouter02]: 102387
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.SishiswapRouter01]: 139259,
              [RouterVersion.SishiswapRouter02]: 139259
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
